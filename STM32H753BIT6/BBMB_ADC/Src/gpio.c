...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, GPIO_PIN_3|GPIO_PIN_14|GPIO_PIN_0, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PE3 PE14 PE0 */
  GPIO_InitStruct.Pin = GPIO_PIN_3|GPIO_PIN_14|GPIO_PIN_0;
