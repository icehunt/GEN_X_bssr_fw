...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
	...
	char msg[100] = "\r\n\r\n\t\tStart MCU\r\n";
	HAL_UART_Transmit(&huart2, msg, 50, 100);
    while (1)
    {
    /* USER CODE END WHILE */
...
static void MX_LPUART1_UART_Init(void)
{
  ...
  hlpuart1.Init.Prescaler = UART_PRESCALER_DIV1;
  hlpuart1.Init.FIFOMode = UART_FIFOMODE_DISABLE;
  hlpuart1.Init.TXFIFOThreshold = UART_TXFIFO_THRESHOLD_1_8;
  hlpuart1.Init.RXFIFOThreshold = UART_RXFIFO_THRESHOLD_1_8;
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, GPIO_PIN_3|GPIO_OUT28_Pin, GPIO_PIN_RESET);
  ...
  HAL_GPIO_WritePin(GPIOI, GPIO_PIN_12|GPIO_PIN_13|GPIO_PIN_14|GPIO_PIN_15 
                          |GPIO_OUT29_Pin|GPIO_OUT30_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOJ, GPIO_PIN_12|GPIO_PIN_13|GPIO_PIN_15, GPIO_PIN_RESET);

  /*Configure GPIO pins : PE3 GPIO_OUT28_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_3|GPIO_OUT28_Pin;
  ...
  /*Configure GPIO pins : PJ12 PJ13 PJ15 */
...
void StartDefaultTask(void const * argument)
{
  ...
  /* USER CODE BEGIN 5 */
    ...
    for(;;)
    {
      ...
      // char rec = 0;
    	// HAL_UART_Receive(&huart2, &rec, 1, 0xff);
      // if (rec == 0)
      //   HAL_UART_Transmit(&huart2, "Alive\r\n", strlen("Alive\r\n"), 100);
      // osDelay(100);
